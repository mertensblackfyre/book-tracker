   ...
   return (function () {
      ...
      var _ = function (e, t) {
         ...
         for (var n = 0; n < r.length; n++) {
            var i = r[n];
            if (
               i.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_PRECEDING
            ) {
               return i;
            }
         }
      ...
      var z = function (e, t) {
         ...
         for (var n = r.length - 1; n >= 0; n--) {
            var i = r[n];
            if (
               i.compareDocumentPosition(e) === Node.DOCUMENT_POSITION_FOLLOWING
            ) {
               return i;
            }
         }
            ...
            if (re(e) && n.cancelled !== true) {
               if (
                  !tt(
                     r,
                     e,
                     Pt("hx:poll:trigger", { triggerSpec: r, target: e })
                  )
               ) {
                  t(e);
               }
